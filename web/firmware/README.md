...
- `rsvp-nano-esp32-s3-touch-amoled-1.8.bin` is the full browser-flasher image for Touch AMOLED 1.8 boards.
- `rsvp-nano-esp32-s3-touch-amoled-1.8-ota.bin` is the board-specific Touch AMOLED 1.8 OTA binary.
