...
import com.rsvpnano.persistence.FileAppSettingsStorage
...
fun createIosSharedDependencies(
    ...
    return RsvpSharedDependencies(
        ...
        appSettingsStore = JsonAppSettingsStore(FileAppSettingsStorage(appGroupIdentifier = appGroupIdentifier)),
