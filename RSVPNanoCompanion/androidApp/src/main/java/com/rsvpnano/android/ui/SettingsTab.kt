        ...
        LazyColumn(
            ...
            item {
                SectionCard(title = "Reader Connection") {
                    if (!hasPermissions) {
                        Text(
                            text = "Grant Wi-Fi permission to let the app find your Nano.",
                    ...
                    if (uiState.rememberedNano != null) {
                        ...
                        Text(
                            text = if (uiState.isConnected) {
                                "No Nano remembered. Android did not expose a Wi-Fi name to save."
                            } else {
                                "No Nano remembered. Connect once, then save it for faster reconnects."
                            },
                            style = MaterialTheme.typography.bodyMedium,
