...
class CompanionViewModel(
    ...
    fun setCalibreBaseUrlDraft(value: String) = presenter.setCalibreBaseUrlDraft(value)
    fun setCalibreSearchQueryDraft(value: String) = presenter.setCalibreSearchQueryDraft(value)
    fun setCalibreUsernameDraft(value: String) = presenter.setCalibreUsernameDraft(value)
    fun setCalibrePasswordDraft(value: String) = presenter.setCalibrePasswordDraft(value)
    fun setCalibreLibraryIdDraft(value: String) = presenter.setCalibreLibraryIdDraft(value)
    fun setCalibreDeletionPolicyDraft(value: String) = presenter.setCalibreDeletionPolicyDraft(value)
    fun setCalibreEnabledDraft(value: Boolean) = presenter.setCalibreEnabledDraft(value)
    fun saveCalibreSettings() = presenter.saveCalibreSettings()
    fun refreshCalibreSettings() = presenter.refreshCalibreSettings()
