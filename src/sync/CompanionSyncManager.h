...
class CompanionSyncManager {
 ...
 private:
  ...
  static void handleCalibreSettingsStatic();
  ...
  String calibreSettingsJson();
  bool applyCalibreSettingsJson(const String &body, String &error);
