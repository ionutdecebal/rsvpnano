...
constexpr const char *kDemoWords[] = {
    "La",          "Rapid",      "Serial",      "Visual",      "Presentation,",
    "o",           "RSVP,",      "\xc3\xa8",    "una",         "tecnica",
    "di",          "lettura",    "che",         "mostra",      "il",
    "testo",       "una",        "parola",      "alla",        "volta",
    "in",          "una",        "posizione",   "fissa",       "sullo",
    "schermo.",    "Invece",     "di",          "spostare",    "gli",
    "occhi",       "lungo",      "righe",       "e",           "paragrafi,",
    "lo",          "sguardo",    "resta",       "ancorato",    "a",
    "un",          "unico",      "punto",       "mentre",      "le",
    "parole",      "scorrono",   "in",          "sequenza.",   "Questo",
    "elimina",     "le",         "saccadi,",    "quei",        "piccoli",
    "movimenti",   "oculari",    "rapidi",      "che",         "durante",
    "la",          "lettura",    "tradizionale", "consumano",  "una",
    "quantit\xc3\xa0", "sorprendente", "di",   "tempo.",

    "Il",          "concetto",   "nasce",       "dalla",       "ricerca",
    "in",          "psicologia", "cognitiva",   "negli",       "anni",
    "Settanta,",   "quando",     "gli",         "scienziati",  "iniziarono",
    "a",           "studiare",   "la",          "velocit\xc3\xa0", "con",
    "cui",         "il",         "cervello",    "umano",       "elabora",
    "il",          "linguaggio", "scritto.",    "Scoprirono",  "che",
    "gran",        "parte",      "del",         "tempo",       "dedicato",
    "alla",        "lettura",    "non",         "viene",       "speso",
    "per",         "comprendere", "le",         "parole,",     "ma",
    "per",         "spostare",   "fisicamente", "gli",         "occhi",
    "da",          "una",        "parola",      "all\xe2\x80\x99" "altra.", "Eliminando",
    "questo",      "sovraccarico", "meccanico,", "i",          "lettori",
    "potevano",    "assorbire",  "il",          "testo",       "molto",
    "pi\xc3\xb9",  "velocemente", "senza",      "perdere",     "in",
    "comprensione.",

    "Un",          "elemento",   "chiave",      "dei",         "lettori",
    "RSVP",        "moderni",    "\xc3\xa8",    "il",          "Punto",
    "di",          "Riconoscimento", "Ottimale,", "o",         "ORP.",
    "Ogni",        "parola",     "ha",          "una",         "lettera",
    "specifica",   "su",         "cui",         "il",          "cervello",
    "si",          "fissa",      "naturalmente", "per",        "prima.",
    "Nelle",       "parole",     "corte",       "tende",       "a",
    "trovarsi",    "vicino",     "all\xe2\x80\x99inizio,", "in", "quelle",
    "pi\xc3\xb9",  "lunghe",     "si",          "sposta",      "leggermente",
    "verso",       "il",         "centro.",     "Allineando",  "questa",
    "lettera",     "in",         "una",         "posizione",   "fissa",
    "sullo",       "schermo",    "ed",          "evidenziandola,", "il",
    "lettore",     "riconosce",  "ogni",        "parola",      "pi\xc3\xb9",
    "rapidamente", "perch\xc3\xa9", "l\xe2\x80\x99occhio", "non", "deve",
    "cercare",     "dove",       "mettere",     "a",           "fuoco.",

    "La",          "velocit\xc3\xa0", "si",     "misura",      "in",
    "parole",      "al",         "minuto,",     "o",           "WPM.",
    "La",          "velocit\xc3\xa0", "media",  "di",          "lettura",
    "silenziosa",  "\xc3\xa8",   "di",          "circa",       "200-250",
    "WPM.",        "Con",        "l\xe2\x80\x99RSVP", "molte", "persone",
    "raggiungono", "comodamente", "le",         "300-500",     "WPM",
    "dopo",        "un",         "breve",       "periodo",     "di",
    "adattamento.", "Alcuni",    "utenti",      "esperti",     "superano",
    "le",          "600",        "WPM,",        "anche",       "se",
    "la",          "comprensione", "pu\xc3\xb2", "calare",     "a",
    "velocit\xc3\xa0", "molto",  "alte",        "a",           "seconda",
    "della",       "complessit\xc3\xa0", "del", "materiale.",

    "Anche",       "la",         "temporizzazione", "\xc3\xa8", "adattiva.",
    "Le",          "parole",     "pi\xc3\xb9",  "lunghe",      "restano",
    "sullo",       "schermo",    "un",          "po\xe2\x80\x99", "di",
    "pi\xc3\xb9",  "perch\xc3\xa9", "richiedono", "pi\xc3\xb9", "tempo",
    "per",         "essere",     "elaborate.",  "Le",          "parole",
    "seguite",     "da",         "punteggiatura", "come",      "virgole,",
    "punti",       "o",          "punti",       "interrogativi", "ricevono",
    "una",         "pausa",      "aggiuntiva",  "per",         "permettere",
    "al",          "cervello",   "di",          "registrare",  "la",
    "fine",        "di",         "una",         "frase",       "o",
    "di",          "un",         "periodo.",    "Questo",      "riproduce",
    "il",          "ritmo",      "naturale",    "della",       "lettura",
    "e",           "impedisce",  "che",         "l\xe2\x80\x99" "esperienza", "risulti",
    "meccanica.",

    "L\xe2\x80\x99RSVP", "\xc3\xa8", "particolarmente", "efficace", "sui",
    "dispositivi", "mobili",     "dove",        "lo",          "spazio",
    "sullo",       "schermo",    "\xc3\xa8",    "limitato.",   "Una",
    "sola",        "parola",     "alla",        "volta",       "non",
    "richiede",    "quasi",      "spazio",      "orizzontale,", "il",
    "che",         "lo",         "rende",       "ideale",      "per",
    "gli",         "smartphone.", "Non",        "c\xe2\x80\x99\xc3\xa8", "scorrimento,",
    "non",         "ci",         "sono",        "pagine",      "da",
    "voltare",     "e",          "nessuna",     "distrazione", "dal",
    "testo",       "circostante.", "Basta",     "tenere",      "premuto,",
    "leggere",     "e",          "lasciare",    "che",         "le",
    "parole",      "arrivino",   "a",           "te.",
};
