...
void lightSleepUntilBootButton() {
  if constexpr (WaveshareC6TouchLcd147::System::kDeepSleepWakePin < 0) {
    return;
  }

  constexpr int wakePin = WaveshareC6TouchLcd147::System::kDeepSleepWakePin;
  pinMode(wakePin, INPUT_PULLUP);
  gpio_wakeup_enable(WaveshareC6TouchLcd147::System::kDeepSleepWakeGpio, GPIO_INTR_LOW_LEVEL);
  esp_sleep_enable_gpio_wakeup();
  Serial.flush();
  esp_light_sleep_start();
  gpio_wakeup_disable(WaveshareC6TouchLcd147::System::kDeepSleepWakeGpio);
...
void deepSleepUntilConfiguredWake() {
  ...
  esp_deep_sleep_enable_gpio_wakeup(BIT64(WaveshareC6TouchLcd147::System::kDeepSleepWakeGpio),
