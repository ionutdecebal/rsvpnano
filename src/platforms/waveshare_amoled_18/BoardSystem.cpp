...
void begin() {
  ...
  beginWire(Wire, WaveshareAmoled18::System::kTouchSdaPin,
            WaveshareAmoled18::System::kTouchSclPin,
            WaveshareAmoled18::System::kTouchI2cClockHz,
            WaveshareAmoled18::System::kTouchI2cTimeoutMs);

  Board::Power::begin();
}

void lightSleepUntilBootButton() {
  if constexpr (WaveshareAmoled18::System::kDeepSleepWakePin < 0) {
    return;
  }

  constexpr int wakePin = WaveshareAmoled18::System::kDeepSleepWakePin;
  pinMode(wakePin, INPUT_PULLUP);
  gpio_wakeup_enable(WaveshareAmoled18::System::kDeepSleepWakeGpio, GPIO_INTR_LOW_LEVEL);
  esp_sleep_enable_gpio_wakeup();
  Serial.flush();
  esp_light_sleep_start();
  gpio_wakeup_disable(WaveshareAmoled18::System::kDeepSleepWakeGpio);
...
void deepSleepUntilConfiguredWake() {
  ...
  esp_sleep_enable_ext0_wakeup(WaveshareAmoled18::System::kDeepSleepWakeGpio, 0);
