...
void begin() {
  ...
  beginWire(Wire1, WaveshareAmoled241::System::kTouchSdaPin,
            WaveshareAmoled241::System::kTouchSclPin,
            WaveshareAmoled241::System::kTouchI2cClockHz,
            WaveshareAmoled241::System::kTouchI2cTimeoutMs);

  Board::Power::begin();
}

void lightSleepUntilBootButton() {
  if constexpr (WaveshareAmoled241::System::kDeepSleepWakePin < 0) {
    return;
  }

  constexpr int wakePin = WaveshareAmoled241::System::kDeepSleepWakePin;
  pinMode(wakePin, INPUT_PULLUP);
  gpio_wakeup_enable(WaveshareAmoled241::System::kDeepSleepWakeGpio, GPIO_INTR_LOW_LEVEL);
  esp_sleep_enable_gpio_wakeup();
  Serial.flush();
  esp_light_sleep_start();
  gpio_wakeup_disable(WaveshareAmoled241::System::kDeepSleepWakeGpio);
...
void deepSleepUntilConfiguredWake() {
  ...
  esp_sleep_enable_ext0_wakeup(WaveshareAmoled241::System::kDeepSleepWakeGpio, 0);
